import { api, type PaginatedQuery } from "../api/axios";
...
export const resumosService = {
  ...
  porPessoa: async (query: PaginatedQuery, signal: AbortSignal | undefined = undefined): Promise<ResumoFinanceiro[]> =>
    (await api.get('/resumos/financeiro/pessoas', { params: query, signal: signal })).data,

  porCategoria: async (query: PaginatedQuery, signal: AbortSignal | undefined = undefined): Promise<ResumoFinanceiro[]> =>
